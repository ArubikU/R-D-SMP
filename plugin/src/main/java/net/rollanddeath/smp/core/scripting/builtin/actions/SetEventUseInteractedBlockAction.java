...
final class SetEventUseInteractedBlockAction {
    private SetEventUseInteractedBlockAction() {}

    static void register() {
        ActionRegistrar.register("set_event_use_interacted_block", SetEventUseInteractedBlockAction::parse);
    }
