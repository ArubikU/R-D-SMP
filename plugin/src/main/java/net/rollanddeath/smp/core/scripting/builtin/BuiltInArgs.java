 ...
 */
final class BuiltInArgs {

    private BuiltInArgs() {
    }

    static String string(Map<?, ?> raw, String key) {
        if (raw == null || key == null) return null;
        Object v = raw.get(key);
        return (v instanceof String s) ? s : null;
    }

    static Integer intValue(Map<?, ?> raw, String key) {
        if (raw == null || key == null) return null;
        Object v = raw.get(key);
    ...
    static Double doubleValue(Map<?, ?> raw, String key) {
        if (raw == null || key == null) return null;
        Object v = raw.get(key);
    ...
    static boolean bool(Map<?, ?> raw, String key, boolean defaultValue) {
        if (raw == null || key == null) return defaultValue;
        Object v = raw.get(key);
        return (v instanceof Boolean b) ? b : defaultValue;
    }

    static boolean invert(Map<?, ?> raw) {
     ...
     */
    static boolean expectedBool(Map<?, ?> raw, boolean defaultValue) {
     ...
     */
    static Map<String, Object> stringObjectMap(Object maybeMap) {
    ...
    static void applyWithArgs(ScriptContext ctx, Map<String, Object> with) {
    ...
    static String lowerType(Map<?, ?> raw) {
