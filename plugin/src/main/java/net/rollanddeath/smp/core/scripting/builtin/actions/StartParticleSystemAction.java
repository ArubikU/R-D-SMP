...
final class StartParticleSystemAction {
    private StartParticleSystemAction() {}

    static void register() {
        ActionRegistrar.register("start_particle_system", StartParticleSystemAction::parse);
    }
    ...
    private static Action parse(Map<?, ?> raw) {
        ...
        Integer periodTicks = Resolvers.integer(null, raw, "period_ticks", "interval");
