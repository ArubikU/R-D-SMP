...
final class AddLivesAction {
    private AddLivesAction() {
    }

    static void register() {
        ActionRegistrar.register("add_lives", AddLivesAction::parse);
    }
    ...
    private static ActionResult execute(ScriptContext ctx, Object amountSpec, Object messageSpec, Object colorSpec) {
        ...
        if (message != null && !message.isBlank()) {
            NamedTextColor c = Optional.ofNullable(Resolvers.color(ctx, colorSpec)).orElse(NamedTextColor.GREEN);
