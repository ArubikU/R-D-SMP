...
final class ApplyEffectToEventEntityAction {
    private ApplyEffectToEventEntityAction() {
    }

    static void register() {
        ActionRegistrar.register("apply_effect_to_event_entity", ApplyEffectToEventEntityAction::parse);
    }
    ...
    private static Action parse(java.util.Map<?, ?> raw) {
        ...
        return BuiltInActions.applyEffectToEventEntity(effect, dur, amp, ambient, particles);
    }
}
